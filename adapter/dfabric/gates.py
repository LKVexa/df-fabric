...
def run_node_battery(container: str, node_id: str, *, full: bool = False,
    ...
    def g_payload():
        ...
        return r
    B.gate("G0.3", "embedded VM payload byte-identical to the pinned digest (source zip content)", g_payload)
    ...
    B.gate("N0", "toolchain preflight against REQUIREMENTS.txt", lambda: dict(pf, _status="PASS"))
