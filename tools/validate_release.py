...
def main():
    ...
    suites = [
        (ROOT, ['-m', 'unittest', 'discover', '-s', 'tests', '-v']),
        (ROOT / 'PHOTON/control_plane', ['-m', 'unittest', 'discover', '-s', 'tests', '-v']),
        (ROOT / 'PHOTON/shell/VEC1', ['-m', 'unittest', 'discover', '-s', 'tests', '-v']),
        (ROOT, ['pk/SELFTEST.py']),
        (ROOT, ['PHOTON/control_plane/VERIFY_PACKAGE.py']),
    ]
